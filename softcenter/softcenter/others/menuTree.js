...
tab: [
{url: "Guest_network.asp", tabName: "<#120#>"},
{url: "Captive_Portal.asp", tabName: "Free Wi-Fi"},
{url: "Captive_Portal_Advanced.asp", tabName: "<#2571#>"},
...
{url: "AiProtection_HomeProtection.asp", tabName: "<#728#>"},
...
{url: "AiProtection_WebProtector.asp", tabName: "<#263#>"},
...
tab: [
{url: "AdaptiveQoS_Bandwidth_Monitor.asp", tabName: "<#856#>"},
{url: "QoS_EZQoS.asp", tabName: "<#1574#>"},
{url: "AdaptiveQoS_WebHistory.asp", tabName: "<#591#>"},
...
tab: [
{url: "TrafficAnalyzer_Statistic.asp", tabName: "<#1975#>"},
{url: "Main_TrafficMonitor_realtime.asp", tabName: "<#500#>"},
...
tab: [
{url: "GameBoost.asp", tabName: "<#1267#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
{url: "mediaserver.asp", tabName: "<#504#>"},
{url: "Advanced_AiDisk_samba.asp", tabName: "<#209#>".concat(WebDav_support?" / <#902#>":"")},
{url: "Advanced_AiDisk_ftp.asp", tabName: "<#210#>"},
...
{url: "cloud_sync.asp", tabName: "<#1961#>"},
{url: "cloud_router_sync.asp", tabName: "<#1907#>"},
{url: "cloud_settings.asp", tabName: "<#1923#>"},
{url: "cloud_syslog.asp", tabName: "<#1541#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
/* ============================================================================================================ */
...
index: "menu_Wireless",
tab: [
{url: "Advanced_Wireless_Content.asp", tabName: "<#192#>"},
{url: "Advanced_WWPS_Content.asp", tabName: "<#193#>"},
{url: "Advanced_WMode_Content.asp", tabName: "WDS"},
{url: "Advanced_ACL_Content.asp", tabName: "<#195#>"},
{url: "Advanced_WSecurity_Content.asp", tabName: "<#196#>"},
{url: "Advanced_WAdvanced_Content.asp", tabName: "<#197#>"},
...
index: "menu_LAN",
tab: [
{url: "Advanced_LAN_Content.asp", tabName: "<#199#>"},
{url: "Advanced_DHCP_Content.asp", tabName: "<#200#>"},
{url: "Advanced_MultiSubnet_Content.asp", tabName: "<#200#>"},
{url: "Advanced_GWStaticRoute_Content.asp", tabName: "<#201#>"},
{url: "Advanced_IPTV_Content.asp", tabName: "IPTV"},
{url: "Advanced_SwitchCtrl_Content.asp", tabName: "<#1997#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_WAN",
tab: [
{url: "Advanced_WAN_Content.asp", tabName: "<#203#>"},
{url: "Advanced_DSL_Content.asp", tabName: "<#203#>"},
{url: "Advanced_VDSL_Content.asp", tabName: "<#203#>"},
{url: "Advanced_Modem_Content.asp", tabName: "<#203#>"},
{url: "Advanced_MobileBroadband_Content.asp", tabName: "<#203#>"},
{url: "Advanced_WANPort_Content.asp", tabName: "<#97#>"},
{url: "Advanced_PortTrigger_Content.asp", tabName: "<#204#>"},
{url: "Advanced_VirtualServer_Content.asp", tabName: "<#205#>"},
{url: "Advanced_Exposed_Content.asp", tabName: "<#206#>"},
{url: "Advanced_ASUSDDNS_Content.asp", tabName: "<#207#>"},
{url: "Advanced_NATPassThrough_Content.asp", tabName: "<#232#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_VPN",
tab: [
{url: "Advanced_VPN_PPTP.asp", tabName: "<#58#>"},
{url: "Advanced_VPN_OpenVPN.asp", tabName: "__INHERIT__"},
{url: "Advanced_VPN_IPSec.asp", tabName: "__INHERIT__"},
{url: "Advanced_VPNClient_Content.asp", tabName: (vpn_fusion_support) ? "VPN Fusion" : "<#2304#>"},/*untranslated*/
...
index: "menu_Firewall",
tab: [
{url: "Advanced_BasicFirewall_Content.asp", tabName: "<#192#>"},
{url: "Advanced_URLFilter_Content.asp", tabName: "<#214#>"},
{url: "Advanced_KeywordFilter_Content.asp", tabName: "<#217#>"},
{url: "Advanced_Firewall_Content.asp", tabName: "<#216#>"},
{url: "Advanced_Firewall_IPv6_Content.asp", tabName: "<#218#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
{
...
index: "menu_Setting",
tab: [
{url: "Advanced_OperationMode_Content.asp", tabName: "<#220#>"},
{url: "Advanced_System_Content.asp", tabName: "<#222#>"},
{url: "Advanced_FirmwareUpgrade_Content.asp", tabName: "<#223#>"},
{url: "Advanced_SettingBackup_Content.asp", tabName: "<#224#>"},
{url: "Advanced_PerformanceTuning_Content.asp", tabName: "Performance tuning"},
{url: "Advanced_ADSL_Content.asp", tabName: "<#186#>"},
{url: "Advanced_Feedback.asp", tabName: "<#1569#>"},
...
index: "menu_Log",
tab: [
{url: "Main_LogStatus_Content.asp", tabName: "<#225#>"},
{url: "Main_WStatus_Content.asp", tabName: "<#227#>"},
{url: "Main_DHCPStatus_Content.asp", tabName: "<#226#>"},
{url: "Main_IPV6Status_Content.asp", tabName: "IPv6"},
{url: "Main_RouteStatus_Content.asp", tabName: "<#229#>"},
{url: "Main_IPTStatus_Content.asp", tabName: "<#228#>"},
{url: "Main_AdslStatus_Content.asp", tabName: "<#185#>"},
{url: "Main_ConnStatus_Content.asp", tabName: "<#925#>"},
...
tab: [
{url: "Main_Analysis_Content.asp", tabName: "<#1690#>"},
{url: "Main_Netstat_Content.asp", tabName: "Netstat"},
{url: "Main_WOL_Content.asp", tabName: "<#1707#>"},
{url: "Advanced_Smart_Connect.asp", tabName: "<#1954#>"},
{url: "NULL", tabName: "__INHERIT__"}
]
},
//========================================
{
menuName: "koolshare - 软件中心",
index: "menu_Split",
tab: [
{url: "NULL", tabName: "__HIDE__"}
]
...
tab: [
{url: "Main_Soft_center.asp", tabName: "软件中心"},
{url: "Module_koolproxy.asp", tabName: "__INHERIT__"},
{url: "Main_Ss_Content.asp", tabName: "__INHERIT__"},
{url: "Main_Ss_LoadBlance.asp", tabName: "__INHERIT__"},
