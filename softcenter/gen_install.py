...
def work_parent():
    ignore_paths = frozenset(["maintain_files", "softcenter", "appledns", "ddnspod", "speedtest", "dualwan", "kcptun", "koolnet", "kuainiao", "shadowvpn", "shellinabox", "swap", "tunnel",  "phddns", "shadowsocks", "ssid" ])
